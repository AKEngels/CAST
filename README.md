...
[![Coverage Status](https://coveralls.io/repos/github/AKEngels/CAST/badge.png?branch=devel)](https://coveralls.io/github/AKEngels/CAST?branch=devel) (for branch devel, coverage does not work yet)

...
{
  S << std::right << std::setw(23) << std::fixed << std::setprecision(20) << hof_kcal_mol;
  S << std::right << std::setw(23) << std::fixed << std::setprecision(20) << e_total;
  S << std::right << std::setw(23) << std::fixed << std::setprecision(20) << e_electron;
  S << std::right << std::setw(23) << std::fixed << std::setprecision(20) << e_core;
  if (endline) S << '\n';
}

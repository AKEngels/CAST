  ...
  */
  ...
  struct neb
  {
    ...
    bool NEB_CONN, CONSTRAINT_GLOBAL, TAU, 
         MIXED_MOVE, INT_PATH, CLIMBING, IDPP;
    neb() :
      OPTMODE("PROJECTED"),
      ...
      INT_PATH(false), CLIMBING(true), IDPP(false)
    {}
  };
  ...
  */
  struct PCA
  {
    ...
    PCA(void) : pca_alignment(true), pca_ref_frame_num(0u), pca_start_frame_num(0u), pca_read_vectors(false), pca_read_modes(false),
       pca_use_internal(false), pca_trunc_atoms_bool(false), pca_trunc_atoms_ignore_hydrogen(false),
      pca_print_probability_density(true), pca_histogram_width(0.), pca_histogram_number_of_bins(32u), pca_offset(1u), 
      pca_trunc_atoms_num(), pca_internal_dih(), pca_internal_ignore_hydrogen(false), pca_dimensions_for_histogramming(1u),

...
namespace config
{
  ...
  /**Number of tasks*/
  static std::size_t const NUM_TASKS = 40;
  ...
  struct tasks
  {
    ...
    */
    enum T
    {
      ...
      WRITE_XYZ, WRITE_PDB, FIND_AS, PMF_IC_PREP, PMF_IC_TEST,
      GET_MONOMERS
    };
  };
  ...
  */
  struct entropy
  {
    ...
    entropy(void) : entropy_alignment(true), entropy_temp(300), entropy_ref_frame_num(0), entropy_start_frame_num(0), entropy_method(1, 6u),
      ...
      knnfunc(2), knnnorm(0), entropy_internal_dih(), entropy_trunc_atoms_num(), useCartesianPCAmodes(false), entropy_mie_order(2u)
    {}
  };

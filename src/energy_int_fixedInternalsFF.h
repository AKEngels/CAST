...
namespace energy
{
  namespace interfaces
  {
    ...
    namespace fixedInternalsFF
    {
      ...
      class fixedInternalsFF
        : public interface_base
      {
      public:
        fixedInternalsFF(coords::Coordinates *cobj);
      ...
      protected:
        ...
        fixedInternalsFF(fixedInternalsFF const & rhs, coords::Coordinates *cobj);
        fixedInternalsFF(fixedInternalsFF && rhs, coords::Coordinates *cobj);

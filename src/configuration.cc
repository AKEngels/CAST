...
void config::parse_option(std::string const option, std::string const value_string)
{
  ...
  else if (option.substr(0, 2) == "MD")
  {
    ...
    else if (option.substr(2) == "thermostat")
    {
      ...
      else if (cv.str() == "Andersen" || cv.str() == "andersen" || cv.str() == "ANDERSEN")
      {
        Config::set().md.thermostat_algorithm = config::molecular_dynamics::thermostat_algorithms::ANDERSEN;
      }
  ...
  else if (option == "entropy_massweight_when_possible")
  {
    std::string holder;
    cv >> holder;
    if (holder == "true" || holder == "True" || holder == "TRUE")
    {
      Config::set().entropy.entropy_use_massweighted = true;
    }
    else if (holder == "false" || holder == "False" || holder == "FALSE")
    {
  ...
  else if (option == "entropy_mw_use_si_units")
  {
    ...
    if (holder == "true" || holder == "True" || holder == "TRUE")
    {
      Config::set().entropy.entropy_mw_use_si_units = true;
    }
    else if (holder == "false" || holder == "False" || holder == "FALSE")
    {
      Config::set().entropy.entropy_mw_use_si_units = false;
    }
  }
  ...
  */
  else if (option.substr(0u, 4u) == "LayD")
  {
    ...
    else if (option.substr(4u) == "het_distance")
    {

...
enum class period : int {
  ...
  static const std::unordered_map<std::string, std::tuple<std::size_t, internals::float_type, period>> pse{
  ...
  inline internals::float_type element_radius(std::string const& key) {

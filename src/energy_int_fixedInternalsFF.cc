...
::tinker::parameter::parameters energy::interfaces::fixedInternalsFF::fixedInternalsFF::tp;
::tinker::parameter::parameters energy::interfaces::fixedInternalsFF::fixedInternalsFF::cparams;
 ...
 */
energy::interfaces::fixedInternalsFF::fixedInternalsFF::fixedInternalsFF (coords::Coordinates *cobj) 
   : interface_base(cobj)
{
  interactions = true;
  if (!tp.valid())
...
energy::interfaces::fixedInternalsFF::fixedInternalsFF::fixedInternalsFF (fixedInternalsFF && rhs, 
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::swap (interface_base &rhs)
{
  swap(dynamic_cast<fixedInternalsFF&>(rhs));
}

void energy::interfaces::fixedInternalsFF::fixedInternalsFF::swap (fixedInternalsFF &rhs)
{
  interface_base::swap(rhs);
...
energy::interface_base * energy::interfaces::fixedInternalsFF::fixedInternalsFF::clone (
  coords::Coordinates * coord_object) const
{
  fixedInternalsFF * tmp = new fixedInternalsFF(*this, coord_object);
  return tmp;
}

energy::interface_base * energy::interfaces::fixedInternalsFF::fixedInternalsFF::move (
  coords::Coordinates * coord_object)
{
  fixedInternalsFF * tmp = new fixedInternalsFF(std::move(*this), coord_object);
  return tmp;
}
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::update (bool const skip_topology)
{
  std::vector<std::size_t> types;
...
std::vector<coords::float_type> energy::interfaces::fixedInternalsFF::fixedInternalsFF::charges() const
{
...
// Output functions
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::print_E (std::ostream &) const
{

}

void energy::interfaces::fixedInternalsFF::fixedInternalsFF::print_E_head (std::ostream &S, bool const endline) const
{
  S << "Potentials\n";
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::print_E_short (std::ostream &S, bool const endline) const
{
  S << "Energies\n";
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::print_G_tinkerlike (std::ostream &S, bool const aggregate) const
{
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::pre    (void)
{
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::post   (void)
{
  energy = 0.0;
...
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::to_stream (std::ostream &S) const 
{ 

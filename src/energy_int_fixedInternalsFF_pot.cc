...
coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::e(void)
{
...
coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::g(void)
{
  pre();      // set everything to zero
...
coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::h(void)
{
  pre();
  throw std::runtime_error("fixedInternalsFF doesn't provide a hessian matrix.");
  //post();
  //return energy;
}

coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::o(void)
{
  throw std::runtime_error("fixedInternalsFF doesn't provide any optimization routines.");
}

template<size_t DERIV>
void energy::interfaces::fixedInternalsFF::fixedInternalsFF::calc(void)
{
#if defined (_OPENMP)
...
namespace energy
{
  ...
  {
    namespace fixedInternalsFF
    {

      //! Bonding Energy
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_12<0>(void)
      {
        using std::abs;
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_12<1>(void)
      {
        using std::abs;
        using scon::len;
        coords::float_type E(0.0);
      ...
      *********************************/
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_13_a<0>(void)
      {
        using std::abs;
        coords::float_type E(0.0);
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_13_a<1>(void)
      {
        using scon::angle;
        using scon::cross;
        using scon::dot;
      ...
      *********************************/
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_13_u<0>(void)
      {
        using scon::len;
        using std::abs;
        coords::float_type E(0.0);
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_13_u<1>(void)
      {
        using scon::len;
        using std::abs;
        coords::float_type E(0.0);
      ...
      *********************************/
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_14<0>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
        ...
        for (auto const & torsion : refined.torsions())
        {
          ...
          for (std::size_t j(0U); j < torsion.p.number; ++j)
          {
            ...
            // l = -1 Potential hat ideal bei 0°, +1 bei 180°
            tE += F * (1.0 + cos * l);
          }
          E += tE;
        }
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_14<1>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
      ...
      *********************************/
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_it<0>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_it<1>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
      ...
      *********************************/
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_imp<0>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
        ...
        for (auto & improper : refined.impropers())
        {
          ...
          if (abs(rtru) > 0.0)
          {
            ...
            coords::float_type da((abs(angle + improper.p.ideal[0U]*SCON_180PI) < abs(angle - improper.p.ideal[0U] * SCON_180PI)) ?
              angle + improper.p.ideal[0U] * SCON_180PI : angle - improper.p.ideal[0U] * SCON_180PI);
      ...
      template<>
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::f_imp<1>(void)
      {
        using scon::cross;
        using scon::dot;
        using scon::len;
      ...
      *********************************/
      ...
      energy::interfaces::fixedInternalsFF::nb_cutoff::nb_cutoff(
      ...
      bool energy::interfaces::fixedInternalsFF::nb_cutoff::factors(coords::float_type const rr,
      ...
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::eQ
      ...
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::gQ
      ...
      @param dQ: reference to variable that saves absolute value of gradient */
      coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::gQ_fep
      ...
      */
      ...
      template<> coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::eV
      ...
      template<> coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::gV
        < ::tinker::parameter::radius_types::R_MIN>
      ...
      @param dV: reference to variable that saves absolute value of gradient*/
      template<> coords::float_type energy::interfaces::fixedInternalsFF::fixedInternalsFF::gV_fep
        < ::tinker::parameter::radius_types::R_MIN>
      ...
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::e_QV
      ...
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_QV
      (coords::float_type const C, coords::float_type const E,
        coords::float_type const R, coords::float_type const d,
     ...
     @param dE: reference to variable that saves gradient divided by distance*/
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_QV_fep
      (coords::float_type const C, coords::float_type const E,
        coords::float_type const R, coords::float_type const d,
      ...
      @param e_v: reference to variable that saves vdw-energy*/
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::e_QV_cutoff
      (coords::float_type const C, coords::float_type const E,
        coords::float_type const R, coords::float_type const d,
      ...
      @param dE: reference to variable that saves gradient divided by distance*/
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_QV_cutoff
      (coords::float_type const C, coords::float_type const E,
        coords::float_type const R, coords::float_type const d,
        coords::float_type const fQ, coords::float_type const fV,
        coords::float_type &e_c, coords::float_type &e_v, coords::float_type &dE) const
      ...
      @param dE: reference to variable that saves gradient divided by distance*/
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_QV_fep_cutoff
      ...
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_nb(void)
      {
      ...
      template< ::tinker::parameter::radius_types::T RT>
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_nb_QV_pairs
      (
      ...
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_nb_QV_pairs_cutoff
      (
        coords::float_type &e_nb, coords::Representation_3D &grad_vector,
        std::vector< ::tinker::refine::types::nbpair> const & pairlist,
        scon::matrix< ::tinker::parameter::combi::vdwc, true> const & params
      ...
      void energy::interfaces::fixedInternalsFF::fixedInternalsFF::g_nb_QV_pairs_fep_io
      (
        coords::float_type &e_nb, coords::Representation_3D &grad_vector,
        std::vector< ::tinker::refine::types::nbpair> const & pairlist,
        scon::matrix< ::tinker::parameter::combi::vdwc, true> const & params

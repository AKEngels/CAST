...
std::vector<std::size_t> qmmm_helpers::get_mm_atoms(std::size_t const num_atoms)
{
  ...
  void qmmm_helpers::restore_outputfiles(config::interface_types::T const &interface, std::string const& id, std::string const& systemname)
  {
    if (interface == config::interface_types::T::DFTB)
    {
      if (file_exists("dftb_in_" + systemname + ".hsd")) rename(("dftb_in_" + systemname + ".hsd").c_str(), "dftb_in.hsd");
      if (file_exists("output_dftb_" + systemname + ".txt")) rename(("output_dftb_" + systemname + ".txt").c_str(), "output_dftb.txt");
      if (file_exists("charges_" + systemname + ".dat")) rename(("charges_" + systemname + ".dat").c_str(), "charges.dat");
      if (file_exists("results_" + systemname + ".tag")) rename(("results_" + systemname + ".tag").c_str(), "results.tag");
    }
    if (interface == config::interface_types::T::MOPAC)
    {
      if (file_exists(id + "_" + systemname + ".xyz")) rename((id + "_" + systemname + ".xyz").c_str(), (id + ".xyz").c_str());
      if (file_exists(id + "_" + systemname + ".out")) rename((id + "_" + systemname + ".out").c_str(), (id + ".out").c_str());
      if (file_exists(id + "_" + systemname + ".arc")) rename((id + "_" + systemname + ".arc").c_str(), (id + ".arc").c_str());
      if (file_exists(id + "_" + systemname + "_sys.out")) rename((id + "_" + systemname + "_sys.out").c_str(), (id + "_sys.out").c_str());
      if (file_exists(id + "_" + systemname + ".xyz.out")) rename((id + "_" + systemname + ".xyz.out").c_str(), (id + ".xyz.out").c_str());
      if (file_exists(id + "_" + systemname + ".xyz.aux")) rename((id + "_" + systemname + ".xyz.aux").c_str(), (id + ".xyz.aux").c_str());
      if (file_exists("mol_" + systemname + ".in")) rename(("mol_" + systemname + ".in").c_str(), "mol.in");
    }
    if (interface == config::interface_types::T::GAUSSIAN)
    {
      if (file_exists(id + "_" + systemname + ".gjf")) rename((id + "_" + systemname + ".gjf").c_str(), (id + ".gjf").c_str());
      if (file_exists(id + "_" + systemname + ".log")) rename((id + "_" + systemname + ".log").c_str(), (id + ".log").c_str());
      if (file_exists(id + "_G_" + systemname + ".gjf")) rename((id + "_G_" + systemname + ".gjf").c_str(), (id + "_G_.gjf").c_str());
      if (file_exists(id + "_G_" + systemname + ".log")) rename((id + "_G_" + systemname + ".log").c_str(), (id + "_G_.log").c_str());
    }
    if (interface == config::interface_types::T::PSI4)
    {
      if (file_exists(id + "_" + systemname + "_inp.dat")) rename((id + "_" + systemname + "_inp.dat").c_str(), (id + "_inp.dat").c_str());
      if (file_exists(id + "_" + systemname + "_out.dat")) rename((id + "_" + systemname + "_out.dat").c_str(), (id + "_out.dat").c_str());
      if (file_exists("grid_" + systemname + ".dat")) rename(("grid_" + systemname + ".dat").c_str(), "grid.dat");
      if (file_exists("grid_field_" + systemname + ".dat")) rename(("grid_field_" + systemname + ".dat").c_str(), "grid_field.dat");
    }
    if (interface == config::interface_types::T::ORCA)
    {
      if (file_exists("orca_" + systemname + ".ges")) rename(("orca_" + systemname + ".ges").c_str(), "orca.ges");
      if (file_exists("orca_" + systemname + ".prop")) rename(("orca_" + systemname + ".prop").c_str(), "orca.prop");
      if (file_exists("orca_" + systemname + ".opt")) rename(("orca_" + systemname + ".opt").c_str(), "orca.opt");
      if (file_exists("orca_" + systemname + ".trj")) rename(("orca_" + systemname + ".trj").c_str(), "orca.trj");
      if (file_exists("orca_" + systemname + ".engrad")) rename(("orca_" + systemname + ".engrad").c_str(), "orca.engrad");
      if (file_exists("orca_property_" + systemname + ".txt")) rename(("orca_property_" + systemname + ".txt").c_str(), "orca_property.txt");
      if (file_exists("orca_" + systemname + ".xyz")) rename(("orca_" + systemname + ".xyz").c_str(), "orca.xyz");
      if (file_exists("orca_" + systemname + ".hess")) rename(("orca_" + systemname + ".hess").c_str(), "orca.hess");
      if (file_exists("orca_" + systemname + ".inp")) rename(("orca_" + systemname + ".inp").c_str(), "orca.inp");
      if (file_exists("pointcharges_" + systemname + ".pc")) rename(("pointcharges_" + systemname + ".pc").c_str(), "pointcharges.pc");
      if (file_exists("output_orca_" + systemname + ".txt")) rename(("output_orca_" + systemname + ".txt").c_str(), "output_orca.txt");
    }
  }

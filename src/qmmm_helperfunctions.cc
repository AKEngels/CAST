...
std::vector<std::size_t> qmmm_helpers::get_mm_atoms(std::size_t const num_atoms)
{
  ...
  void qmmm_helpers::restore_outputfiles(config::interface_types::T const &interface, std::string const& id, std::string const& systemname)
  {
    if (interface == config::interface_types::T::DFTB && Config::get().energy.dftb.verbosity > 0)
    {
      if (file_exists("dftb_in.hsd")) rename(("dftb_in_" + systemname + ".hsd").c_str(), "dftb_in.hsd");
      if (file_exists("output_dftb.txt")) rename(("output_dftb_" + systemname + ".txt").c_str(), "output_dftb.txt");
      if (file_exists("charges.dat")) rename(("charges_" + systemname + ".dat").c_str(), "charges.dat");
      if (file_exists("results.tag")) rename(("results_" + systemname + ".tag").c_str(), "results.tag");
    }
    if (interface == config::interface_types::T::MOPAC && Config::get().energy.mopac.delete_input == false)
    {
      if (file_exists(id + ".xyz")) rename((id + "_" + systemname + ".xyz").c_str(), (id + ".xyz").c_str());
      if (file_exists(id + ".out")) rename((id + "_" + systemname + ".out").c_str(), (id + ".out").c_str());
      if (file_exists(id + ".arc")) rename((id + "_" + systemname + ".arc").c_str(), (id + ".arc").c_str());
      if (file_exists(id + "_sys.out")) rename((id + "_" + systemname + "_sys.out").c_str(), (id + "_sys.out").c_str());
      if (file_exists(id + ".xyz.out")) rename((id + "_" + systemname + ".xyz.out").c_str(), (id + ".xyz.out").c_str());
      if (file_exists(id + ".xyz.aux")) rename((id + "_" + systemname + ".xyz.aux").c_str(), (id + ".xyz.aux").c_str());
      if (file_exists("mol.in")) rename(("mol_" + systemname + ".in").c_str(), "mol.in");
    }
    if (interface == config::interface_types::T::GAUSSIAN && Config::get().energy.gaussian.delete_input == false)
    {
      if (file_exists(id + ".gjf")) rename((id + "_" + systemname + ".gjf").c_str(), (id + ".gjf").c_str());
      if (file_exists(id + ".log")) rename((id + "_" + systemname + ".log").c_str(), (id + ".log").c_str());
      if (file_exists(id + "_G_.gjf")) rename((id + "_G_" + systemname + ".gjf").c_str(), (id + "_G_.gjf").c_str());
      if (file_exists(id + "_G_.log")) rename((id + "_G_" + systemname + ".log").c_str(), (id + "_G_.log").c_str());
    }
    if (interface == config::interface_types::T::PSI4)
    {
      if (file_exists(id + "_inp.dat")) rename((id + "_" + systemname + "_inp.dat").c_str(), (id + "_inp.dat").c_str());
      if (file_exists(id + "_out.dat")) rename((id + "_" + systemname + "_out.dat").c_str(), (id + "_out.dat").c_str());
      if (file_exists("grid.dat")) rename(("grid_" + systemname + ".dat").c_str(), "grid.dat");
      if (file_exists("grid_field.dat")) rename(("grid_field_" + systemname + ".dat").c_str(), "grid_field.dat");
    }
    if (interface == config::interface_types::T::ORCA)
    {
      if (file_exists("orca.ges")) rename(("orca_" + systemname + ".ges").c_str(), "orca.ges");
      if (file_exists("orca.prop")) rename(("orca_" + systemname + ".prop").c_str(), "orca.prop");
      if (file_exists("orca.opt")) rename(("orca_" + systemname + ".opt").c_str(), "orca.opt");
      if (file_exists("orca.trj")) rename(("orca_" + systemname + ".trj").c_str(), "orca.trj");
      if (file_exists("orca.engrad")) rename(("orca_" + systemname + ".engrad").c_str(), "orca.engrad");
      if (file_exists("orca_property.txt")) rename(("orca_property_" + systemname + ".txt").c_str(), "orca_property.txt");
      if (file_exists("orca.xyz")) rename(("orca_" + systemname + ".xyz").c_str(), "orca.xyz");
      if (file_exists("orca.hess")) rename(("orca_" + systemname + ".hess").c_str(), "orca.hess");
      if (file_exists("orca.inp")) rename(("orca_" + systemname + ".inp").c_str(), "orca.inp");
      if (file_exists("pointcharges.pc")) rename(("pointcharges_" + systemname + ".pc").c_str(), "pointcharges.pc");
      if (file_exists("output_orca.txt")) rename(("output_orca_" + systemname + ".txt").c_str(), "output_orca.txt");
    }
  }

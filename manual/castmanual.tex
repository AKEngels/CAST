...
\end{itemize}
	...
	If the ``MDadjust\_by\_step'' option is activated your molecule might explode during the simulation. To solve this problem choose a larger inner cutoff (``MDcutoff'') or a lower temperature (``MDheat'').

...
\end{align}
	...
	\textbf{Attention!} For a FEP run you always need some kind of temperature control switched on as otherwise CAST doesn't calculate the current temperature which is needed to calculate the free energy.

...
You can perform several graphical analyses on MD trajectories. To create the graphs CAST uses the python matplotlib module to plot the distances so you have to compile CAST with python enabled and matplotlib must be installed.

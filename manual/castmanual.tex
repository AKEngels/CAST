...
\begin{document}
	...
	\begin{tabularx}{\textwidth}{l|X|r}
		...
		pca_internal_dih & Specify number of atoms (starting with "0") for which the dihedral angle in radians will be included in the dPCA (see \cite{dpca1, dpca2, dpca3}) (example: "3-7,8,13,15,79-115") & none\\

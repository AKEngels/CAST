...
\item \textit{Add the charge of the atom type in place of the question marks in the corresponding charge-line in the .prm file. You can either take the charge of a corresponding ``normal'' amber atom type or search your .prmtop file for it by using the python script ``amber\_find\_atomnumber\_and\_charge''. There you have to put the name of your .prmtop file in the first line and your get a file named ``charges.txt'' with consecutive numbers, atom types and charges.}
\end{itemize}

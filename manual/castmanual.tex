...
To use DFTBaby out of CAST a few modifications are needed. So copy the files ``DFTB2\_cast.py'' and ``utils\_cast.py'' from the folder ``cast\textbackslash optional\_files\textbackslash DFTBaby-files'' to ``DFTBaby-\#\#\#/DFTB. Now CAST is ready for DFTB calculations.

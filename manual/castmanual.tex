...
\end{lstlisting}
The tolerance for the constraint is given by \texttt{OPT++constraintTol} I don't know what constraint tolerance exactly means and it's not explained in the OPT++ documentation but another constraint tolerance was implemented only in the QNIPS optimizer of OPT++ and causes the programm not to accept a step if the constraint is more different to the ideal value. From CAST you can set this tolerance with \texttt{OPT++hardConTol}.

...
\end{align}
	...
	\begin{tabularx}{\textwidth}{l|X|X}
		...
		\textbf{FEPanalyze} & switch on or off analyzing of FEP calculation <0/1> & bool [1] \\
	\end{tabularx}\\~\\

...
\end{align}
	...
	\begin{tabularx}{\textwidth}{l|X|X}
		...
		\textbf{FEPvdwcouple} & Controls coupling of \ac{VdW} interactions (somehow $\lambda_{vdw}$ is calculated from it) \fi & float [1.0] \\
		\textbf{FEPeleccouple} & Controls coupling of electrostatics (somehow $\lambda_{el}$ is calculated from it) 
		& float [1.0] \\

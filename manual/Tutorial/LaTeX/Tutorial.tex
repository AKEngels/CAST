...
Because now the WHAM calculation lasts much longer it is submitted to the queue by the function \texttt{submit\_pbs()}. If you don't want this but instead want to run \texttt{wham2d} on the headnode just replace the last line by:

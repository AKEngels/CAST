...
\begin{itemize}
	...
	\item Our energy \texttt{interface} is \texttt{OPLSAA}.
	\item The \texttt{paramfile} is called \texttt{oplsaa\_mod2.prm}. You can find this file in the Github Repository in \mbox{optional\_files/forcefields\_utility}.
...
### things users probably want to change are marked with USER INPUT ###
...
# copies all necessary files for a calculation into folders and changes lines in inputfiles
def run_calc(step):

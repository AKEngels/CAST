...
Before we continue we shoud repeat the calculations which are broken. If you are lucky then nothing is broken and you can continue below with detailed plotting. If not go into the corresponding folders and repeat the calculations. As they are quite short the best might be to do this on the headnode so you just type \texttt{.\textbackslash CAST.exe} into the terminal.

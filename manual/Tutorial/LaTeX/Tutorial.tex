...
# USER INPUT
STEPS = range(-180, 185, 5)           # to which values was the restraint set? 
...
if copy_and_and_create_inputfile():
    ...
    if REACTION_COORD == "bond":
        ...
        os.popen("{} P {} {} {} {:.9f} {} 0 in.txt out.txt".format(PATH,MIN,MAX,BINS,TOL,TEMP)) |\label{runWHAM}|
    else:
...
\begin{itemize}
	...
	\item WHAM needs to know if your reaction coordinate is a bond or a torsion because in case of a torsion it takes into account the symmetry. This information is given by \texttt{REACTION\_COORD}.
